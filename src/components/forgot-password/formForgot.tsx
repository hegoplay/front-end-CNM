...
import PreRegister from "../register/preRegister";
  ...
  const handleCheckPhone = async () => {
    try {
      ...
      if (response.data.isExist === false) {
          ...
          message.error("Số điện thoại chưa tồn tại, vui lòng đăng ký tài khoản mới");
          restartFn();
          return;

      }
      // Nếu số điện thoại tồn tại, tiếp tục gửi OTP
      handleSendOtp();
